    ...
    <main className="container" style={{ padding: "2rem", maxWidth: "900px", margin: "2rem auto" }}>
      ...
      <section style={{ marginTop: "2rem" }}>
        <p style={{ fontSize: "1.1rem", color: "#666" }}>
          Join our team and help us revolutionize e-commerce in India. 
          We're looking for talented, passionate individuals to help us build the future of online shopping.
        </p>
      </section>
      ...
      <section style={{ marginTop: "3rem" }}>
        ...
        <p style={{ color: "#999", marginTop: "1rem" }}>
          ...
          Please check back soon or send your resume to <a href="mailto:careers@azcoglobal.com" style={{ color: "#0066c0" }}>careers@azcoglobal.com</a>
        </p>
      </section>
