  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p>
          Shopfront Marketplace ("we", "us", or "our") operates the Shopfront
          Marketplace website. This page informs you of our policies regarding
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p>
          ...
          computer's IP address, browser type, browser version, the pages you
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p>
          Email:{" "}
          <a href="mailto:privacy@azcoglobal.com" style={{ color: "#0066c0" }}>
            privacy@azcoglobal.com
          </a>
          <br />
