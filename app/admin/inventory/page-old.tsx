    ...
    <main style={{ maxWidth: "1200px", margin: "0 auto", padding: "2rem" }}>
      ...
      >
        ...
        >
          ...
          >
            {inventory.reduce((sum, item) => sum + item.totalStock, 0)}
          </div>
          ...
          >
            {
              inventory.filter(
                (i) =>
                  getStatusLabel(i.availableStock, i.reorderLevel) === "ok",
              ).length
            }
          </div>
          <div style={{ fontSize: "0.9rem", color: "#666" }}>
          ...
          >
            {
              inventory.filter(
                (i) =>
                  getStatusLabel(i.availableStock, i.reorderLevel) === "low",
              ).length
            }
          </div>
          <div style={{ fontSize: "0.9rem", color: "#666" }}>
          ...
          >
            {
              inventory.filter(
                (i) =>
                  getStatusLabel(i.availableStock, i.reorderLevel) ===
                  "critical",
              ).length
            }
          </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{ padding: "1rem", textAlign: "center" }}>
                        ...
                        >
                          {status === "critical" ? "Reorder" : "Update"}
                        </button>
                      </td>
                    </tr>
                  );
