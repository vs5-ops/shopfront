...
export const CATALOG: CatalogProduct[] = [
  ...
  },
  {
    ...
    description:
      "The Helios TurboCharge 67W USB-C adapter features cutting-edge GaN (Gallium Nitride) technology for fast, efficient charging. With dual port support (USB-C + USB-A), it can charge multiple devices simultaneously. Perfect for laptops, tablets, smartphones, and gaming devices. The compact design makes it travel-friendly while delivering up to 67W of power through USB-C.",
    specifications: {
      "Total Power": "67W",
  ...
  },
  {
    ...
    description:
      "Elevate your casual wardrobe with the Aurora Cotton Oversized Graphic T-Shirt. Made from premium 240 GSM cotton, this tee offers exceptional durability and comfort. The relaxed oversized fit is perfect for a laid-back aesthetic, while the fade-resistant print ensures your design stays vibrant after multiple washes. Available in multiple eye-catching designs.",
    specifications: {
  ...
  },
  {
    ...
    description:
      "Brew the perfect cup of coffee with ZenBrew's premium stainless steel French press. Double-wall insulation keeps your coffee hot for up to 4 hours, reducing the need for frequent reheating. The rust-resistant construction ensures durability, while the fine mesh filter system extracts optimal flavor without sediment. Perfect for coffee enthusiasts and office use.",
    specifications: {
      Capacity: "1L (8 cups)",
  ...
  },
  {
    ...
    highlights: [
      "Bat + pads + gloves",
      "Lightweight guard",
      "School tournament ready",
    ],
    description: "Complete cricket kit for beginners and young players",
    specifications: { battery: "N/A", weight: "3.5kg" },
  },
  {
    id: "p9",
    ...
    highlights: [
      "Bestseller",
      "Premium paper",
      "Author interview bonus chapter",
    ],
    description: "Transform your habits and master the fundamentals",
    specifications: { pages: "384", language: "English" },
  },
  {
    id: "p10",
    ...
    description: "Master clean coding principles with illustrated examples",
    specifications: { pages: "464", language: "English" },
  },
];
